...
%
\providecommand{\maxlink}[1]{{maxima_html/}#1}%
\providecommand{\maxman}[2]{\htmladdnormallink{#1}{{maxima_html/}#2}}%
\providecommand{\umaxman}[2]{\htmladdnormallink{{\bf #1}}{{maxima_html/}#2}\maxcom\index{#1@{\bf #1}}}%
\providecommand{\imaxman}[2]{\htmladdnormallink{#1}{{maxima_html/}#2}\index{#1}} 
...
\htmladdnormallink{simplified}{{maxima_html/}maxima_7.html#SEC29} by writing it as a canonical rational expression (CRE)
