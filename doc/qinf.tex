...
\title{User's Manual for \qinf Quantum Information and Entanglement Package
 v. 0.06 For The \pname{Maxima} Computer
  Algebra System}
...
\subsection{\ifs{renyi\_entropy}}
 \func{renyi\_entropy}{\rho} gives the R\'enyi entropy, defined by
\begin{equation}
...
\subsection{\ifs{tsallis\_entropy}}
 \func{tsallis\_entropy}{\rho} gives the Tsallis entropy, defined by
\begin{equation}
