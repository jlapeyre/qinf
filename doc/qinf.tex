...
\title{User's Manual for \qinf Quantum Information and Entanglement Package
 v. 0.09 For The \pname{Maxima} Computer
  Algebra System}
...
\subsection{\fs{pauli} --- pauli matrices$.$}
\ibd{pauli}
\marray{pauli}{i}
...
\subsection{{\bf pauli\_product} ---  tensor product of pauli matrices$.$}
\ibd{pauli\_product}
...
\subsection{\fs{pauliexp} --- expansion of operator in terms of tensor products of pauli matrices$.$}
\ibd{pauliexp}
...
\subsection{\fs{invpauliexp} --- inverse of expansion in terms of tensor products of pauli matrices$.$}
\ibd{invpauliexp}
